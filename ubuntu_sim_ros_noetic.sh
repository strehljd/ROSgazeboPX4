# Copy of https://raw.githubusercontent.com/PX4/PX4-Devguide/pr-installation-instructions-noetic/build_scripts/ubuntu_sim_ros_noetic.sh (jan)
...
. <(echo "${./ubunut_sim_common_deps.sh}")
...
# Otherwise source the downloaded script.
chmod +x ./install_geographiclib_datasets.sh # allow to execute the script
sudo bash -c ./install_geographiclib_datasets.sh
